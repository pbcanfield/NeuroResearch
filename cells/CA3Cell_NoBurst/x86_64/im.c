...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 im /home/pbczgf/NeuroResearch/cells/CA3Cell_NoBurst/x86_64/im.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbczgf/NeuroResearch/cells/CA3Cell_NoBurst/modfiles/im.mod";
static const char* nmodl_file_text = 
