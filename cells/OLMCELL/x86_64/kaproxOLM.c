...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kapOLM /home/pbczgf/NeuroResearch/cells/OLMCELL/x86_64/kaproxOLM.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbczgf/NeuroResearch/cells/OLMCELL/modfiles/kaproxOLM.mod";
static const char* nmodl_file_text = 
