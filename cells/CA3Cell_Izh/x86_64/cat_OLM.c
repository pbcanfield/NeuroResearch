...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 catOLM /home/pbczgf/NeuroResearch/cells/CA3Cell_Izh/x86_64/cat_OLM.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbczgf/NeuroResearch/cells/CA3Cell_Izh/modfiles/cat_OLM.mod";
static const char* nmodl_file_text = 
