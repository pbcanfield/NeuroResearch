...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 natDG /home/pbcanfield/Desktop/NeuroResearch/cells/CA3Cell_Izh/x86_64/natDG.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/pbcanfield/Desktop/NeuroResearch/cells/CA3Cell_Izh/modfiles/natDG.mod";
static const char* nmodl_file_text = 
  "TITLE nat\n"
  ": Na current \n"
  ": from Jeff M.\n"
