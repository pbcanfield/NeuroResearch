...
#define nrn_init _nrn_init__VVClamp
#define _nrn_initial _nrn_initial__VVClamp
#define nrn_cur _nrn_cur__VVClamp
#define _nrn_current _nrn_current__VVClamp
#define nrn_jacob _nrn_jacob__VVClamp
#define nrn_state _nrn_state__VVClamp
#define _net_receive _net_receive__VVClamp 
#define update update__VVClamp 
#define vstim vstim__VVClamp 
...
#endif
  hoc_register_prop_size(_mechtype, 26, 2);
  hoc_register_dparam_semantics(_mechtype, 0, "area");
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 VVClamp /home/mizzou/Desktop/NeuroResearch/SBI_Segregated/x86_64/VVClamp.mod\n");
...
double icur (  ) {
 ...
 if(error){fprintf(stderr,"at line 141 in file VVClamp.mod:\n		SOLVE clamp\n"); nrn_complain(_p); abort_run(error);}
 _licur = ( vo - v ) / rstim ;
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/NeuroResearch/SBI_Segregated/modfiles/VVClamp.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
