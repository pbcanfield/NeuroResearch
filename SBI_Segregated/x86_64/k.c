...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 k /home/mizzou/Desktop/NeuroResearch/SBI_Segregated/x86_64/k.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
   double _lna , _lnb ;
  ninf = 1.0 / ( 1.0 + exp ( ( nvhalf - _lv ) / nk ) ) ;
   if ( _lv < - 55.0 ) {
     ninf = 0.0 ;
     }
   ntau = ncbase + ncamp * exp ( ( - pow( ( nvpeak - _lv ) , 2.0 ) ) / pow( nsigma , 2.0 ) ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/mizzou/Desktop/NeuroResearch/SBI_Segregated/modfiles/k.mod";
static const char* nmodl_file_text = 
