function [ ] = DrawTheta(expSig, fftHan, suffix)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here


areaCode = [0 1 2 3 4 5 6];
OutPath = '../../NeuroResearch/theta/';
...
% CA3
fileNames = dir([OutPath 'bmtk_' expSig '_SpikeTime' num2str(1) '.txt']);
fprintf('The file dir is: %s\n', fileNames.name);
...
for sname = fn
    ...
    [f,Pxxn,tvect,Cxx] = psautospk(ev, 0.1, windowLen, bartlett(windowLen), windowLen/2) ;
...
saveas(gcf, join([suffix '.png']))
fprintf('test to see if it gets here\n');
