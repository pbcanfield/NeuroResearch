...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 cagkDG C:/Users/Tyler/Desktop/git_stage/hippocampus-bmtk/GuntuBanks-bmtk/biophys_components/mechanisms/modfiles/CaBK.mod\n");
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  state();
 if(error){fprintf(stderr,"at line 66 in file CaBK.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
